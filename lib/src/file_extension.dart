...
extension FileExtension on File {
  /// Determines if this [File] is an image.
  bool get isImage => type == FileType.image;

  /// Determines if this [File] is a video.
  bool get isVideo => type == FileType.video;

  /// Determines if this [File] is an audio file.
  bool get isAudio => type == FileType.audio;

  /// Determines if this [File] is a text file.
...
extension NullableFileExtension on File? {
  /// Determines if this [File] is an image.
  bool get isImage => (this?.type != null) && this!.isImage;

  /// Determines if this [File] is a video.
  bool get isVideo => (this?.type != null) && this!.isVideo;

  /// Determines if this [File] is an audio file.
  bool get isAudio => (this?.type != null) && this!.isAudio;

  /// Determines if this [File] is a text file.
  bool get isText => (this?.type != null) && this!.isText;

  /// Gets the file name.
  String get name => this != null ? this!.name : '';

  /// Gets the file name without the extension.
  String get displayName => this != null ? this!.displayName : '';

  /// Gets the file extension.
  String get extension => this != null ? this!.extension : '';

  /// Gets the file mimeType.
  String get mimeType => this != null ? this!.mimeType : '';

  /// Get the file type as an enum.
  FileType get type => this != null ? this!.type : FileType.unknown;
}

const Map<String, String> _mimeTypeMap = <String, String>{
